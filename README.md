# ffmpeg-stream-restreamer

Restream one input to multiple RTMP endpoints.
...
### Example
```bash
docker compose run --rm ffmpeg-tool python app.py --dry-run rtmp://source/live rtmp://dest-a/live rtmp://dest-b/live
```
